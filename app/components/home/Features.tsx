import { CloudRain, Rocket, Shield, Smile } from "lucide-react";
...
const features = [
  ...
  {
    name: "Blazing Fast",
    description: "The blog is very fast and easy to create.",
    icon: Rocket,
  },
  {
    name: "Super secure with Kinde",
    description: "Super secure with Kinde",
    icon: Shield,
  },
  {
    name: "Easy to use",
    ...
    <div className="py-24 sm:py-32">
      <div className="max-w-2xl mx-auto lg:text-center">
        ...
        <p className="mt-6 text-base leading-snug text-muted-foreground">
          ...
          to create blog in minutes. The blog is very fast and easy to create.
        </p>
      </div>
